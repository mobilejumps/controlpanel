...
# Script Created by Cammy <support@mobilejumps.mobi>
...
sed -i 's|export KEY_COUNTRY="SG"|export KEY_COUNTRY="SG"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_PROVINCE="SG"|export KEY_PROVINCE="TAR"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_CITY="SINGAPORE"|export KEY_CITY="SINGAPORE"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_ORG="CammyEnos"|export KEY_ORG="CammyEnos"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_EMAIL="support@mobilejumps.mobi"|export KEY_EMAIL="support@mobilejumps.mobi"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU="MyOrganizationalUnit"|export KEY_OU="CammyEnos"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_NAME="EasyRSA"|export KEY_NAME="CammyEnos"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU=changeme|export KEY_OU=CammyEnos|' /etc/openvpn/easy-rsa/vars
...
useradd openvpn
echo "openvpn:mobilejumps" | chpasswd
clear
