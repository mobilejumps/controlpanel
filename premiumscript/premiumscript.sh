#!/bin/bash
# Created by https://www.sample.com
# Modified by Cammy
...
cd /usr/local/bin
wget -O premium-script.tar.gz "https://raw.githubusercontent.com/mobilejumps/controlpanel/main/premiumscriptfolder/premium-script.tar.gz"
